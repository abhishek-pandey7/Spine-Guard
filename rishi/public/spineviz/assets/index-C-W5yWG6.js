(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))i(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const a of s.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&i(a)}).observe(document,{childList:!0,subtree:!0});function n(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(o){if(o.ep)return;o.ep=!0;const s=n(o);fetch(o.href,s)}})();const T="bcd9eee09ce044ef98a69c315aa792e2";let l=null,E=!1;const k={C1:[0,130,10],C2:[0,120,10],C3:[0,110,10],C4:[0,100,10],C5:[0,90,10],C6:[0,80,10],C7:[0,70,10],T1:[0,60,5],T2:[0,50,5],T3:[0,40,5],T4:[0,30,5],T5:[0,20,5],T6:[0,10,5],T7:[0,0,5],T8:[0,-10,5],T9:[0,-20,5],T10:[0,-30,5],T11:[0,-40,5],T12:[0,-50,5],L1:[0,-62,8],L2:[0,-72,8],L3:[0,-82,8],L4:[0,-92,8],L5:[0,-102,8],S1:[0,-115,5],S2:[0,-122,5],S3:[0,-129,5]},B={cervical:[0,100,10],thoracic:[0,5,5],lumbar:[0,-82,8],sacral:[0,-120,5]},A={cervical:"#ff8c42",thoracic:"#3a8fff",lumbar:"#00d4aa",sacral:"#c77dff",affected:"#ff4455"};function $(e){const t=document.getElementById("sketchfab-iframe");function n(){if(!window.Sketchfab){setTimeout(n,100);return}new window.Sketchfab(t).init(T,{success(o){l=o,l.start(),l.addEventListener("viewerready",()=>{E=!0,console.log("[SpineViz] Viewer ready"),e&&e()})},error(o){console.error("Sketchfab init error",o),e&&e()},ui_stop:0,ui_infos:0,ui_watermark:0,ui_annotations:0,ui_controls:1,preload:1,autostart:1,camera:0})}n()}function m(){l&&l.getAnnotationList(e=>{if(!(!e||!e.length))for(let t=e.length-1;t>=0;t--)l.removeAnnotation(t,()=>{})})}function M(e){if(m(),!l)return;const t=B[e],n=A[e]||"#ffffff",i=e.charAt(0).toUpperCase()+e.slice(1);t&&L(t,i+" Region",n)}function I(e){m(),!(!l||!e.length)&&setTimeout(()=>{e.forEach(t=>{const n=k[t.toUpperCase()];n?L(n,"⚠ "+t.toUpperCase(),"#ff4455"):console.warn("[SpineViz] No 3D position for level:",t)})},300)}function L(e,t,n){if(!l)return;const i=[e[0]+80,e[1]+20,e[2]+150],o=[e[0],e[1],e[2]];l.addAnnotation(e,i,o,t,"",(s,a)=>{if(s){console.warn("[SpineViz] addAnnotation failed:",s),O(t,n);return}console.log("[SpineViz] Annotation added at index",a,"— label:",t),R(a,n)})}function R(e,t){var n;try{const i=document.getElementById("sketchfab-iframe"),o=i.contentDocument||((n=i.contentWindow)==null?void 0:n.document);if(!o)return;const s="sf-ann-style-"+e;if(o.getElementById(s))return;const a=document.createElement("style");a.id=s,a.textContent=`
    ...
    `,n.appendChild(a),!document.getElementById("sf-styles")){const c=document.createElement("style");c.id="sf-styles",c.textContent="@keyframes sfPulse{0%{box-shadow:0 0 0 0 #ff445599}70%{box-shadow:0 0 0 12px transparent}100%{box-shadow:0 0 0 0 transparent}}",document.head.appendChild(c)}}function u(){return E}const P="gemini-2.5-flash",N="https://generativelanguage.googleapis.com/v1beta/models";let d=null,f=null;const D=`You are a Neuroradiology AI. Analyze the attached spine image.
...
}`;function _(e){const t=document.getElementById("file-inp"),n=document.getElementById("upload-zone");document.getElementById("api-key-wrap"),n.addEventListener("dragover",i=>{i.preventDefault(),n.classList.add("drag")}),n.addEventListener("dragleave",()=>n.classList.remove("drag")),n.addEventListener("drop",i=>{i.preventDefault(),n.classList.remove("drag"),i.dataTransfer.files[0]&&w(i.dataTransfer.files[0])}),t.addEventListener("change",i=>{i.target.files[0]&&w(i.target.files[0])})}function w(e,t){const n=new FileReader;n.onload=i=>{f=e.type||"image/jpeg",d=i.target.result.split(",")[1],document.getElementById("mri-preview").src=i.target.result,document.getElementById("preview-wrap").style.display="block",document.getElementById("upload-zone").classList.add("has-img"),document.getElementById("analyse-btn").disabled=!1},n.readAsDataURL(e)}function j(){d=null,f=null,document.getElementById("mri-preview").src="",document.getElementById("preview-wrap").style.display="none",document.getElementById("upload-zone").classList.remove("has-img"),document.getElementById("analyse-btn").disabled=!0,document.getElementById("ai-result").style.display="none";const e=document.getElementById("scan-bar");e&&e.classList.remove("active"),document.getElementById("file-inp").value=""}async function z(){var y,v,h,b;const e=(y=document.getElementById("api-key-inp"))==null?void 0:y.value.trim())||"AIzaSyCw47DTNDYSK-A7fQhSLJumhMTxJtj0BKg";if(!e)throw new Error("Gemini API key not configured. Please contact support.");if(!d)throw new Error("Please upload an MRI image first.");const t=`${N}/${P}:generateContent?key=${e}`,n=await fetch(t,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({contents:[{parts:[{inline_data:{mime_type:f,data:d}},{text:D}]}],generationConfig:{temperature:0,maxOutputTokens:2048,responseMimeType:"application/json"}})});if(!n.ok){const r=await n.json().catch(()=>({}));throw new Error(((v=r==null?void 0:r.error)==null?void 0:v.message)||`HTTP ${n.status}`)}const i=await n.json(),o=(h=i==null?void 0:i.candidates)==null?void 0:h[0];if(!o)throw new Error("Gemini returned no candidates. Try again.");const a=(((b=o==null?void 0:o.content)==null?void 0:b.parts)||[]).map(r=>r.text||"").join("").trim(),c=a.indexOf("{"),p=a.lastIndexOf("}");if(c===-1||p===-1)throw console.error("[SpineViz] No JSON block found. Raw text:",a),new Error("AI response did not contain a valid JSON object.");const g=a.substring(c,p+1);try{const r=JSON.parse(g);return(!r.affectedLevels||!Array.isArray(r.affectedLevels))&&(r.affectedLevels=[]),r}catch(r){throw console.error("[SpineViz] JSON Parse Error:",r,"Raw:",g),new Error("Failed to parse AI medical data. The response was truncated.")}}const F={cervical:{clr:"#ff8c42",rgb:"255,140,66",tag:"C1–C7 · NECK",title:`Cervical
...
`,"<br>"),document.getElementById("rp-sub").textContent=n.sub;const o=document.getElementById("diag-banner");t?(o.style.display="block",document.getElementById("diag-banner-val").textContent=`${t.finding} · Recommended: ${t.surgery}`):o.style.display="none";const s=document.getElementById("rp-body");s.innerHTML=G(t)+H(n)+J(n)+U(n)+W(n)}function G(e,t){return e?`
    ...
    </div>`}$(()=>{console.log("SpineViz: viewer ready")});_();window.clearMRI=function(){j(),C()};window.analyseMRI=async function(){const e=document.getElementById("analyse-btn");e.disabled=!0,e.innerHTML='<span class="btn-ico">⏳</span> Analysing…',document.getElementById("scan-bar").classList.add("active"),document.getElementById("ai-result").style.display="none",C();try{const t=await z();q(t)}catch(t){S(`❌ ${t.message}`),console.error(t)}finally{e.disabled=!1,e.innerHTML='<span class="btn-ico">🔬</span> Analyse with Gemini AI',document.getElementById("scan-bar").classList.remove("active")}};function q(e){const t=e.affectedLevels||[],n=e.region||null,i=Math.min(100,Math.max(0,e.confidence||0)),o=e.finding||"Unknown finding",s=e.recommendedSurgery||"Consult surgeon";if(document.getElementById("ai-result").style.display="block",document.getElementById("res-level").textContent=t.join(", ")||"None detected",document.getElementById("res-conf").textContent=`${i}%`,document.getElementById("conf-fill").style.width=`${i}%`,document.getElementById("res-finding").textContent=o,!t.length||!n){S("ℹ No specific spinal pathology detected.");return}document.querySelectorAll(".reg-btn").forEach(c=>{c.classList.toggle("highlighted",c.dataset.region===n)});const a=document.getElementById("affected-popup");if(a.style.display="block",document.getElementById("popup-label").textContent="⚠ AI Detected",document.getElementById("popup-level").textContent=t.join(" · "),document.getElementById("popup-finding").textContent=o,u())I(t);else{const c=setInterval(()=>{u()&&(clearInterval(c),I(t))},500)}x(n,{levels:t,finding:o,surgery:s,conf:i})}window.selectRegion=function(e,t=null){x(e,t)};function x(e,t=null){document.querySelectorAll(".reg-btn").forEach(n=>{n.classList.toggle("active",n.dataset.region===e)}),!t&&u()&&M(e),document.getElementById("region-overlay").style.display="block",V(e,t)}function C(){m(),document.getElementById("affected-popup").style.display="none",document.getElementById("diag-banner").style.display="none",document.getElementById("region-overlay").style.display="none",document.querySelectorAll(".reg-btn").forEach(e=>{e.classList.remove("highlighted")})}function S(e,t=4500){const n=document.getElementById("toast");n.textContent=e,n.className="show",setTimeout(()=>n.className="",t)}
